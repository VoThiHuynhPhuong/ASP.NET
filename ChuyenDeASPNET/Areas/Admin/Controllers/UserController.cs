...
namespace ChuyenDeASPNET.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Index(string searchTerm, int? page)
        {
            ...
            var lstUser = objASPNETEntities.User.AsQueryable();
        ...
        {
            var objUser = objASPNETEntities.User.Where(n => n.Id == Id).FirstOrDefault();
            return View(objUser);
        }
        ...
        {
            var objUser = objASPNETEntities.User.Where(n => n.Id == objUse.Id).FirstOrDefault();

            objASPNETEntities.User.Remove(objUser);
        ...
        public ActionResult Create(User objUser)
        {
            try
            {
                ...
                objASPNETEntities.User.Add(objUser);
                objASPNETEntities.SaveChanges();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var user = objASPNETEntities.User.Find(id);
        ...
        public ActionResult Edit(User objUser)
        {
            try
            {
                var existingUser = objASPNETEntities.User.Find(objUser.Id);
