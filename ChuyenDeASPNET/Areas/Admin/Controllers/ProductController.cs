...
namespace ChuyenDeASPNET.Areas.Admin.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Index(string searchTerm, int? page)
        {
            ...
            var lstProduct = objASPNETEntities.Product.AsQueryable();
        ...
        {
            var objProduct = objASPNETEntities.Product.Where(n => n.Id == Id).FirstOrDefault();
        ...
        public ActionResult Create()
        {
            ...
            var categories = objASPNETEntities.Category.ToList();
            ViewBag.CategoryId = new SelectList(categories, "Id", "Name");

            var brands = objASPNETEntities.Brand.ToList();
        ...
        public ActionResult Create(Product objProduct)
        {
            try
            {
                ...
                objASPNETEntities.Product.Add(objProduct);
        ...
        {
            var objProduct = objASPNETEntities.Product.Where(n => n.Id == objPro.Id).FirstOrDefault();

            objASPNETEntities.Product.Remove(objProduct);
            objASPNETEntities.SaveChanges();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var product = objASPNETEntities.Product.Find(id);
            if (product == null) return HttpNotFound();

            // Truyền danh sách Category và Brand vào ViewBag
            ViewBag.CategoryId = new SelectList(objASPNETEntities.Category, "Id", "Name", product.CategoryId);
            ViewBag.BrandId = new SelectList(objASPNETEntities.Brand, "Id", "Name", product.BrandId);
        ...
        public ActionResult Edit(Product objProduct)
        {
            try
            {
                var existingProduct = objASPNETEntities.Product.Find(objProduct.Id);
