...
namespace ChuyenDeASPNET.Areas.Admin.Controllers
{
    ...
    public class OrderController :Controller
    {
        ...
        public ActionResult Index(string searchTerm, int? page)
        {
            ...
            var lstOrder = objASPNETEntities.Order.AsQueryable();
        ...
        {
            var objOrder = objASPNETEntities.Order.Where(n => n.Id == Id).FirstOrDefault();
        ...
        {
            var objOrder = objASPNETEntities.Order.Where(n => n.Id == objOrde.Id).FirstOrDefault();

            objASPNETEntities.Order.Remove(objOrder);
        ...
        public ActionResult Create(Order objOrder)
        {
            try
            {
                ...
                objASPNETEntities.Order.Add(objOrder);
                objASPNETEntities.SaveChanges();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var order = objASPNETEntities.Order.Find(id);
        ...
        public ActionResult Edit(Order objOrder)
        {
            try
            {
                var existingOrder = objASPNETEntities.Order.Find(objOrder.Id);
